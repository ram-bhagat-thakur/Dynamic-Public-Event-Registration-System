    ...
    return (
        <>
            <div>
                ...
                <p className='text-center text-2xl w-1/2 m-auto mt-5'>Built as part of the Civora Nexus Internship, empowering student developers to build real-world apps</p>
